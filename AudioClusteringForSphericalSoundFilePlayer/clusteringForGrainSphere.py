...
audio_file_path = "data/SchleuseUnterDerBrueckeWasserEntkommt.wav"
audio_sample_rate = 48000
#audio_excerpt_length = 1000 # in milisecs
audio_excerpt_length = 300 # in milisecs
...
for excerpt_index, label in enumerate(labels):
    ...
    audio_file_name = "data_proc/SchleuseUnterDerBrueckeWasserEntkommt_{:05d}_clusterIndex_{:05d}_fileIndex_{:05d}.wav".format(label, excerpt_index, fileIndex)
