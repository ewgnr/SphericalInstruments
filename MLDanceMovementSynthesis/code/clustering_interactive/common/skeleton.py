# skeleton implementation with functions to remove joints and to do forward kinematics
# code adapted from original pyTorch implementation of Quaternet 
# quaternet / common / skeleton.py

# TODO: verify correctness of code, in particular the forward kinematics function still contains torch specific code such as expand
