...
class MotionGui(QtWidgets.QWidget):
    ...
    def update_osc(self):
        ...
        joint_pos_scale = config["joint_pos_scale"]
        
        self.synth_pose_wpos_rh[:, 0] = self.synth_pose_wpos[:, 0] * joint_pos_scale
        self.synth_pose_wpos_rh[:, 1] = self.synth_pose_wpos[:, 1] * joint_pos_scale
        self.synth_pose_wpos_rh[:, 2] = self.synth_pose_wpos[:, 2] * joint_pos_scale
        ...
        self.synth_pose_wrot_rh[:, 1] = self.synth_pose_wrot[:, 1]
        self.synth_pose_wrot_rh[:, 2] = self.synth_pose_wrot[:, 2]
        self.synth_pose_wrot_rh[:, 3] = self.synth_pose_wrot[:, 3]

        self.sender.send("/mocap/joint/pos", self.synth_pose_wpos_rh)
        self.sender.send("/mocap/joint/rot", self.synth_pose_wrot_rh)
